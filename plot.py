...
def draw_from_nodes(nodes: List[Node], **kwargs):
...
def draw_colored_graph(
    ...
    )  # positions for all nodes, you can use other layouts like shell, random, etc.
